package app.validator.data.model;
...
public class PlaylistDialog extends BottomSheetDialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        SharedPreferences preferences = this.getActivity().getSharedPreferences(Const.MY_PREF, Context.MODE_PRIVATE);
    ...
    private ArrayList<MediaFiles> fetchMedia(String folderName) {
        ...
        if (cursor != null && cursor.moveToNext()) {
            do {
                ...
                @SuppressLint("Range") MediaFiles mediaFiles = new MediaFiles(id, title, displayName, size, duration, path,
                        dateAdded);
