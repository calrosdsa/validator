...
import app.validator.data.model.BrightnessDialog;
import app.validator.data.model.IconModel;
import app.validator.data.model.MediaFiles;
import app.validator.data.model.OnSwipeTouchListener;
import app.validator.data.model.Utility;
import app.validator.data.model.VolumeDialog;
import app.validator.presentation.adapter.PlaybackIconsAdapter;
import app.validator.presentation.adapter.VideoFilesAdapter;
...
public class VideoPlayerActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentFile = CaptureApplication.Companion.getCurrentFile();

        MediaMetadataRetriever retriever = new MediaMetadataRetriever();
//use one of overloaded setDataSource() functions to set your data source
        retriever.setDataSource(this, Uri.fromFile(currentFile));
...
//        mVideoFiles = getIntent().getExtras().getParcelableArrayList("videoArrayList");
        MediaFiles mediaFile = new MediaFiles(
                "1","Preview",
                "Preview",
                Long.toString(currentFile.getTotalSpace()),
                Long.toString(timeInMillisec),
                currentFile.getPath(),
                "2024-02-12"
                );

        mVideoFiles.add(mediaFile);
        Log.d("DEBUG_APP",mVideoFiles.toString());
